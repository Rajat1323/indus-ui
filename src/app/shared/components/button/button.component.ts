...
export class ButtonComponent implements OnInit {
  ...
  impactClasses: Record<ButtonProps['tone'], Record<ButtonProps['impact'], string>> = {
    primary: {
      bold: 'bg-[#1f731f] text-primary-foreground hover:bg-[#1f731f]/90 focus-visible:ring-primary',
      light: 'bg-[#1f731f]/20 text-primary hover:bg-[#1f731f]/30 focus-visible:ring-primary',
      none: 'bg-transparent text-primary hover:bg-[#1f731f]/10 focus-visible:ring-primary',
    },
    danger: {
